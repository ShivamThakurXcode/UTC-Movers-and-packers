      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm">
              Your trusted partner in logistics and moving services. Making
              relocations smooth and stress-free.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-center text-sm">
            © {new Date().getFullYear()} UTC Movers and Packers. Developed by
            Shivam Thakur, Dynexia System.
          </p>
        </div>
      </div>
    </footer>
